...
namespace nm_network
{
	...
	int32_t CTcpListener::open(const CIpv4Addr &listenaddr, int32_t i32backlog, const nm_engine::engine_ptr_t &pengine)
	{
	...
	CTcpListenerEvt::CTcpListenerEvt(tcp_listener_ptr_t &ptcplistener, nm_framework::endpoint_ptr_t &pep, int32_t i32opcode) :
