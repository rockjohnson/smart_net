...
namespace nm_smartnet
{
	...
	namespace nm_rup
	{
		 ...
		 * */
		class CRupEndpoint;
		typedef nm_utils::CSmartPtr<nm_smartnet::nm_rup::CRupEndpoint> rup_endpoint_ptr_t;
		...
		typedef nm_utils::CSmartPtr<nm_smartnet::nm_rup::CRupAcceptor> tcp_acceptor_ptr_t;
		...
		typedef nm_utils::CSmartPtr<nm_smartnet::nm_rup::CRupConnector> tcp_connector_ptr_t;
	...
	namespace nm_rmp
	{
		...
		private:
			nm_utils::CStateMachine<nm_smartnet::nm_rmp::CRmpEndpoint> m_sm;
			nm_framework::sn_engine_ptr_t m_pSNEngine;
