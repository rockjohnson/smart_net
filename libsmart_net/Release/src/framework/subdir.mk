...
src/framework/%.o: ../src/framework/%.cpp
	...
	g++ -I"/home/rock/Workspace/smart_net/smart_net/comm_utils/src" -I"/home/rock/Workspace/smart_net/smart_net/rmp/src" -O3 -Wall -c -fmessage-length=0 -Wreorder -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
